...
func main() {
	...
	managerCmd.Flags().StringVarP(&arguments.ConfigFile, "configFile", "c", "", "Path to the config file (default: manager.conf)")
	managerCmd.Flags().StringVarP(&arguments.ConfigSSHFile, "configSSHFile", "f", "", "Path to the config SSH file (default: empty)")
	...
	workerCmd.Flags().StringVarP(&arguments.ConfigFile, "configFile", "c", "", "Path to the config file (default: worker.conf)")
...
func managerStart(arguments *Arguments) {
	...
	manager.StartManager(arguments.Swagger, arguments.ConfigFile, arguments.ConfigSSHFile, arguments.VerifyAltName, arguments.Verbose, arguments.Debug)
}
