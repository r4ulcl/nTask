...
func main() {
	...
	managerCmd.Flags().StringVarP(&arguments.ConfigFile, "configFile", "c", "manager.conf", "Path to the config file")
	...
	workerCmd.Flags().StringVarP(&arguments.ConfigFile, "configFile", "c", "worker.conf", "Path to the config file")
